...
const Portfolio = React.forwardRef((props, ref) => {
  ...
  const artists = [
    ...
    { 
      ...
      profileSrc: miniProfile, // Medium Dark Gray
      phone: '+91 9495556649', 
    ...
    { 
      ...
      profileSrc: sajiProfile, // Medium Gray
      phone: '+91 9544449403', 
    ...
    { 
      ...
      profileSrc: sajithProfile, // Lighter Gray
      phone: '+91 9946998488', 
    ...
    { 
      ...
      profileSrc: sudharmaProfile, // Light Medium Gray
      phone: '+91 9447190578', 
